...
// Marketplace platform fee set to 15%
export const MARKETPLACE_FEE_PERCENTAGE = 0.15;
...
export const DEFAULT_DESIGN_BRIEF = {
  intro: "To deliver the best possible result tailored to your vision, please provide the following when you place your order:",
  req1: "",
  req2: "",
  req3: "",
  req4: ""
